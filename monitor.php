        ...
        if ($type_anchors["type"] == $game_type) {
            foreach ($type_anchors["anchors"] as $anchor) {
                ...
                if (empty($state) || $state == 0) {
                    $offlne .= '<div><span style="width:170px;float:left;font-size:2.2vw">' . $anchor["name"] . '</span><span style="color:#666666;width:40px;"><strong>离线</strong></span><span style="margin-left:25px;font-size:2.2vw">
                        ' . $anchor["url"] . '</span></div>';
                } else {
                    $online .= '<div><span style="width:170px;float:left;"><strong>' . $anchor["name"] . '</strong></span>
                            ...
                            <span style="margin-left:25px; font-size:2.2vw">' . $anchor["url"] . '</span></div>';
                }
            }
        }
    }
